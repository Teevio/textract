var fs = require( 'fs' )
  ...
  , WHITELIST_PRESERVE_LINEBREAKS = /[^\u00a9\u00ae\u2000-\u3300\ud83c\ud000\udfff\ud83d\ud000-\udfff\ud83e\ud000-\udfffA-Za-z\x80-\xFF\x24\u20AC\xA3\xA5 0-9 \u2015\u2116\u2018\u2019\u201C|\u201D\u2026 \uFF0C \u2013 \u2014 \u00C0-\u1FFF \u2C00-\uD7FF \uFB50–\uFDFF \uFE70–\uFEFF \uFF01-\uFFE6 \.,\?""!@#\$%\^&\*\(\)-_=\+;:<>\/\\\|\}\{\[\]`~'-\w\n\r]*/g  // eslint-disable-line max-len
  , WHITELIST_STRIP_LINEBREAKS = /[^\u00a9\u00ae\u2000-\u3300\ud83c\ud000\udfff\ud83d\ud000-\udfff\ud83e\ud000-\udfffA-Za-z\x80-\xFF\x24\u20AC\xA3\xA5 0-9 \u2015\u2116\u2018\u2019\u201C|\u201D\u2026 \uFF0C \u2013 \u2014 \u00C0-\u1FFF \u2C00-\uD7FF \uFB50–\uFDFF \uFE70–\uFEFF \uFF01-\uFFE6 \.,\?""!@#\$%\^&\*\(\)-_=\+;:<>\/\\\|\}\{\[\]`~'-\w]*/g  // eslint-disable-line max-len
  ;
  ...
  return function( error, text ) {
    if ( !error ) {
      ...
      if ( options.preserveLineBreaks || options.preserveOnlyMultipleLineBreaks ) {
        ...
        console.log('CLEANSETEXT: 66', text)
      } else {
        text = text.replace( WHITELIST_STRIP_LINEBREAKS, ' ' );
        console.log('CLEANSETEXT: 69', text)
      }
